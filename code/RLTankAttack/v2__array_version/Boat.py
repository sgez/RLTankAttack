...
class Boat(pygame.sprite.Sprite):
    def __init__(self, img, boat_array, surface):
        ...
        self.boat_array = boat_array
        self.set_coords(boat_array)
        self.draw()
    ...
    def get_coords(self):
        ...
        retval=np.where(self.boat_array == True)
